...
const CambiarPassword = () => {
  ...
  const handleSubmit = async e => {
    ...
    //console.log(Object.values(password).every(campo => campo === '')) //every revisa que todo este lleno (some al menos uno)
    if(Object.values(password).some(campo => campo === '')){ //every revisa que todo este lleno (some al menos uno))
      setAlerta({
        msg: 'Todos los campos son bligatrios',
        error:true
      })
      return
    }
